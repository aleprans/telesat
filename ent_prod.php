    ...
    <div id="central" name="central">
        <form action="#" method="post" id="form">
            ...
            <div class="col-sm-1 col-md-2 ">
                ...
                <input type="number" name="qtde" id="qtde" class="form-control" autocomplete="off" maxlength="10" min="1" placeholder="0"><br>
            </div>
            
            <dic class="clearfix"></dic>
            <div class="col-sm-1 col-md-5">
                <input id="estornar" name="estornar" value="Realizar entrada" type="button" class="btn btn-success btn-lg" onClick="validar()"></input>
...
<script src="script/ent_est.js"></script>
</body>
